      ...
      <div className="container mx-auto px-4 relative">
        <div className="max-w-3xl mx-auto text-center">
          ...
          {!subscribed ? (
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                <div className="relative flex-grow">
                  <input
                    ...
                    } focus:outline-none focus:ring-2 focus:ring-black/30 bg-white/5 text-black placeholder:text-black/50`}
                    disabled={loading}
                  />
                  {error && (
                ...
                <button
                  type="submit"
                  className="bg-black text-white py-3 px-6 rounded-md font-medium hover:bg-black/90 transition-colors disabled:opacity-70"
                  disabled={loading}
                >
            ...
            <div className="bg-black/10 text-black rounded-md p-6 max-w-md mx-auto border border-black/20">
              ...
              <p className="text-sm text-black/80">We've sent a confirmation email to <span className="font-medium">{email}</span>.</p>
            </div>
          )}
        </div>
